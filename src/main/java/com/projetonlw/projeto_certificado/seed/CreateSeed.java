package com.projetonlw.projeto_certificado.seed;
...
public class CreateSeed {
    ...
    public static void main(String[] args) {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/certificacao");
        dataSource.setUsername("root");
        dataSource.setPassword("");  // Alterar conforme necessário
